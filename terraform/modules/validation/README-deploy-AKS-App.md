...
`/tf/caf/modules/validation/azure-vote-internet.yaml` into a local file `azure-vote-internet.yaml`.

`/tf/caf/modules/validation/azure-vote-intranet.yaml` into a local file `azure-vote-intranet.yaml`.
