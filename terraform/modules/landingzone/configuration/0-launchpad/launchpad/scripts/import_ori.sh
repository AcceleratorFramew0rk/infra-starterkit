...
configure_project_files "ab4-dev-sea-rg-launchpad" "$RG_NAME"
configure_project_files "ab4devseastgtfstateevc" "$STG_NAME"
configure_project_files "ab4-dev-sea" "$PROJECT_CODE"
