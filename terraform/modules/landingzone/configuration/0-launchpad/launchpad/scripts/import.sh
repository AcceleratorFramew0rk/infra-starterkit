...
# Prompt for environment with a default value
ENVIRONMENT=$(prompt_for_input "Enter the ENVIRONMENT (dev, sit, uat, prd)" "dev")

CONFIG_FILE_PATH="./../scripts/config.yaml"
# copy config file to working folder CONFIG_FILE_PATH
SRC_CONFIG_FILE="./../../../../../environments/${ENVIRONMENT}/config.yaml" # /tf/avm/terraform/environments/${ENVIRONMENT}/config.yaml"
DEST_CONFIG_FILE=$CONFIG_FILE_PATH
echo $SRC_CONFIG_FILE
echo $DEST_CONFIG_FILE
cp $SRC_CONFIG_FILE $DEST_CONFIG_FILE

#------------------------------------------------------------------------
# end setup config file
#------------------------------------------------------------------------
...
# DIRECTORY_PATH="/tf/avm/terraform/modules/landingzone"      
...
# begin rename modules to folder name
...
# end rename modules to folder name
