...
# -----------------------------------------------------------------------------------------------------
cd /tf/avm/terraform/modules/landingzone/configuration/2-solution_accelerators/project/redis_cache
...
# -----------------------------------------------------------------------------------------------------
cd /tf/avm/terraform/modules/landingzone/configuration/2-solution_accelerators/project/app_service_windows
...
VNET_NAME=$(yq  -r '.vnets.project.name' /tf/avm/terraform/modules/landingzone/configuration/0-launchpad/scripts/config.yaml)
echo $VNET_NAME
