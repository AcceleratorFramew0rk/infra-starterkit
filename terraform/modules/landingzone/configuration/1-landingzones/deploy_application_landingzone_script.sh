...
# spoke project 
cd /tf/avm/terraform/modules/landingzone/configuration/1-landingzones/application/networking_spoke_project
...
# spoke devops 
cd /tf/avm/terraform/modules/landingzone/configuration/1-landingzones/application/networking_spoke_devops
...
cd /tf/avm/terraform/modules/landingzone/configuration/1-landingzones/application/networking_peering_project_devops
