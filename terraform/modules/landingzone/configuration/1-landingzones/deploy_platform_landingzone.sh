...
# egress internet
cd /tf/avm/terraform/modules/landingzone/configuration/1-landingzones/platform/networking_hub_internet_egress
...
# ingress internet
cd /tf/avm/terraform/modules/landingzone/configuration/1-landingzones/platform/networking_hub_internet_ingress
...
# egress intranet
cd /tf/avm/terraform/modules/landingzone/configuration/1-landingzones/platform/networking_hub_intranet_egress
...
# ingress intranet
cd /tf/avm/terraform/modules/landingzone/configuration/1-landingzones/platform/networking_hub_intranet_ingress
...
# management
cd /tf/avm/terraform/modules/landingzone/configuration/1-landingzones/platform/networking_spoke_management
