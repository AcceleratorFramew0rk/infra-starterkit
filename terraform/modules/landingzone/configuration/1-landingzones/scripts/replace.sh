...
# sudo chmod -R -f 777 /tf/avm/terraform/modules/landingzone/configuration/1-landingzones/nsg/csv/replace.sh
...
# CONFIG_FILE_PATH="/tf/avm/terraform/modules/landingzone/configuration/0-launchpad/scripts/config.yaml"
