...
# tfexe apply -path=/tf/avm/templates/landingzone/configuration/2-solution_accelerators/project/vm -var=vm_count=2 -var=subnet_name=WebSubnet
# tfexe apply -path=/tf/avm/templates/landingzone/configuration/2-solution_accelerators/project/vm -var=vm_count=1 -var=subnet_name=DbSubnet -backend-config-key=solution-accelerators-project-vm-db.tfstate
