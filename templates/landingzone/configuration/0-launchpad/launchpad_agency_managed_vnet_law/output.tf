...
output "gcci_agency_workspace" {
  value = {
    id = try(azurerm_log_analytics_workspace.gcci_agency_workspace.id, null)
    name = try(azurerm_log_analytics_workspace.gcci_agency_workspace.name, null)
    resource = try(azurerm_log_analytics_workspace.gcci_agency_workspace, null)
  }
  description = "The log analytics workspace gcci_agency_workspace for gcci platform"
  sensitive = true  
}
